...
/** Plain copies so Alpine x-for can iterate (frozen registry objects do not). */
function sourceRowModels() {
...
export function createWorkbench() {
  const wb = {
    ...
    init() {
      ...
      this.sourceRows = sourceRowModels();
    ...
    goScreen(screen, id = null) {
      ...
      if (screen === SCREENS.ATLAS) {
        ...
        this._ensureProject();
        this.closeOverlays("snapshotsOpen");
    ...
    closeOverlays(except) {
      const keys = ["sourcesOpen", "reportOpen", "ioOpen", "privacyOpen", "projectsOpen", "snapshotsOpen"];
      for (const k of keys) {
        if (k !== except) this.ui[k] = false;
      }
    },

    openIo() {
      this.closeOverlays("ioOpen");
      this.ui.ioOpen = true;
    },

    openPrivacy() {
      this.closeOverlays("privacyOpen");
    ...
    openProjects() {
      this.closeOverlays("projectsOpen");
    ...
    openSources() {
      this.closeOverlays("sourcesOpen");
      this.sourceRows = sourceRowModels();
